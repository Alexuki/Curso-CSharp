...
Aunque añadimos 2 middlewares, solo estamos registrando uno en el Inyector de Dependencias porque las dependencias necesarias
para el middleware de autorización se registran automáticamente en el registro (3.3).
...
vamos a requerir que el usuario esté autenticado y su nombre sea "smith". En ese caso, el usuario estará dentro de "Family".
...
Permite usar lógica dentro de la Policy. Así, si nos logueamos con "peter smith", se aplicará la política.
...
//(3.2)
/*
app.UsseAuthentication();
app.UsseAuthorization();
*/
